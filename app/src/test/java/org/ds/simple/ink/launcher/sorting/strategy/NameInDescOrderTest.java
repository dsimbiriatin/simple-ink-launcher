...
public class NameInDescOrderTest {
    ...
    public void shouldOrderApplicationInfosByLabelInDescendingOrder() {
        ...
        // when
        Collections.sort(unorderedApplicationInfoList, new NameInDescOrder());

        // then
        assertThat(unorderedApplicationInfoList.get(0).getLabel(), is("Phone"));
        assertThat(unorderedApplicationInfoList.get(1).getLabel(), is("Messages"));
        assertThat(unorderedApplicationInfoList.get(2).getLabel(), is("Gallery"));
        assertThat(unorderedApplicationInfoList.get(3).getLabel(), is("Browser"));
    }
}